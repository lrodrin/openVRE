                                    ...
                                    if ($ds_list) {
                                        $datasets = [
                                            ['_id' => 'EGAD0001000309',
                                                ...
                                                'description' => 'Studies for cardiovascular-related to obesity',
                                                'version' => '1.0',
                                                'datatype' => 'Exome Seq',
                              ...
                              <i class="font-green fa fa-download tooltips disabled" aria-hidden="true" style="font-size:22px;" data-container="body" data-html="true" data-placement="right" data-original-title="<p align='left' style='margin:0'>Import dataset to workspace</p>"></i></a> -->
                                                        ...
                                                        <form action="../applib/getData.php" method="post">
                                                            ...
                                                            <input type="hidden" name="url"
                                                                   value="<?php echo htmlspecialchars($dataset_uri); ?>"/>
                                                            <input type="hidden" name="data_type"
                                                                   value="<?php echo htmlspecialchars($obj->type); ?>"/>
                                                            <input type="hidden" name="description"
                                                                   value="<?php echo htmlspecialchars($obj->description); ?>"/>
                                                            <input type="hidden" name="oeb_dataset_id"
                                                                   value="<?php echo htmlspecialchars($obj->_id); ?>"/>
                                                            <?php foreach ((array)$obj->community_ids as $community_id) { ?>
                                                                <input type="hidden" name="oeb_community_ids[]"
                                                                       value="<?php echo htmlspecialchars($community_id); ?>"/>
                                                            <?php } ?>
                                                            <button type="submit" class="btn green dropdown-toggle"
                                                                    value="submit">
                                                                <i class="fa fa-download tooltips font-white"
                                                                   data-original-title="Import dataset to workspace"></i>
                                                            </button>
                                                        </form>

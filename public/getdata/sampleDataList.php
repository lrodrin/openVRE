    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="row">
                ...
                <form name="sampleDataForm" id="sampleDataForm" action="../applib/getData.php" method="post"
                      class="horizontal-form">

                    <div class="portlet box blue-oleo">
                        <div class="portlet-title">
                            <div class="caption">
                                <div style="float:left;margin-right:20px;"><i class="fa fa-database"></i> Select example
                                    dataset
                                </div>
                            </div>
                        </div>
                        <div class="portlet-body form">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-field-enabled valid select2naf"
                                                    name="sampleData[]" id="sampleData" aria-invalid="false">
                                                ...
                                                foreach ($sampleList as $sampleId => $sample) {
                                                    ...
                                                    ?>
                                                    <option value="<?php echo /*rtrim($sample['sample_path'], "/");*/
                                                    $sample['_id']; ?>"><?php echo $sampleName; ?></option><?php
                                                }
                                                ?>
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p class="font-grey-mint">
                                            <?php
                                            foreach ($sampleList as $sampleId => $sample) {
                                                ?><span class="display-hide sample-description"
                                                        id="<?php echo /*rtrim($sample['sample_path'], "/");*/
                                                        $sample['_id']; ?>">
                                                <i class="fa fa-sticky-note"
                                                   aria-hidden="true"></i> <?php echo $sample['short_description']; ?>
                                                </span><?php
                                            }
                                            ?>
                                        </p>
                            ...
                            <div class="form-actions">
                                <button type="submit" class="btn blue" id="btn-sample"><i class="fa fa-check"></i>
                                    Import
                                </button>
                            </div>
                        </div>

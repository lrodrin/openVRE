...
<?php require "../htmlib/menu.inc.php"; ?>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content" id="body-help">
            ...
            <p>
                iPC is being developed so as to cater for the needs of the bioinformatics community, especially
                software developers who need an objective and quantitative way to inform their decisions as well as the
                larger community of end-users, in their search for unbiased and up-to-date evaluation of bioinformatics
                methods.</p>

            <p>
                The goals of iPC are to:

            <ul>
                <li>Provide guidance and software infrastructure for Benchmarking and Techincal monitoring of
                ...
                <li>Establish and refine communication protocols with communities and/or infrastructure projects willing
                    to have a unified benchmark infrastructure Coordinate with Elixir.
                </li>

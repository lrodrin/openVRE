    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
                ...
                <li class="nav-item  <?php if ($currentSection == 'dt') { ?>active open<?php } ?>">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="nav-item <?php if ($currentSubSection == 'rp') { ?>active open<?php } ?>">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item <?php if ($currentSubSubSection == 'bs') { ?>active open<?php } ?>">
                                    <a href="getdata/ipc/ipc_projects.php" class="nav-link">
                            ...
                            <ul class="sub-menu">
                                <?php foreach ($tools as $t) {
                                    ...
                                    <li class="nav-item <?php if ($currentSubSubSection == $t["_id"]) { ?>active open<?php } ?>">
                                        <a href="help/toolhelp.php?tool=<?php echo $t["_id"]; ?>&sec=help"
                                           class="nav-link">
                                        ...
                                        <ul class="sub-menu">
                                            <?php foreach ($sections as $sec) {
                                                ...
                                                <li class="nav-item <?php if ($currentSubSubSubSection == substr($sec['help'], 0, 3)) { ?>active open<?php } ?>">
                                                    <a href="help/toolhelp.php?tool=<?php echo $t["_id"]; ?>&sec=<?php echo $sec['help']; ?>"
                                                       class="nav-link">
                ...
                <li class="nav-item active open beta-long"
                    style="color:white;margin-left:18px;margin-top:10px;font-size:12px;">This is the 1.1 version
                    of <?php echo $GLOBALS['AppPrefix']; ?> VRE
                </li>
                <li class="nav-item active open beta-short"
                    style="color:white;margin-left:8px;margin-top:10px;font-size:12px;display:none;">v1.1
                </li>

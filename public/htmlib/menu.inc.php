	...
	<div class="page-sidebar-wrapper">
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
				...
				<li class="nav-item active open beta-long" style="color:white;margin-left:18px;margin-top:10px;font-size:12px;">This is the 1.1 version of <?php echo $GLOBALS['AppPrefix']; ?> VRE</li>
				<li class="nav-item active open beta-short" style="color:white;margin-left:8px;margin-top:10px;font-size:12px;display:none;">v1.1</li>
